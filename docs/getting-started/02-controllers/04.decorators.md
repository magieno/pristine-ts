...
If you make a `POST` HTTP call to `/api/cats/Garfield`, the `id` parameter will have the value `Garfield` and the response will return:

> This is the id 'Garfield'.
