<p>
   <strong>Previous section: </strong> <a href="02.request.md">Request</a>
</p>
...
located at [../../../packages/common/src/models/response.ts](../../../packages/common/src/models/response.ts)
...
**[packages/express/src/mappers/response.mapper.ts](../../../packages/express/src/mappers/response.mapper.ts)**
